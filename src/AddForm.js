...
class AddForm extends React.Component {
    ...
    render() {
        ...
        return <Form>
            ...
            <FormItem>
                {getFieldDecorator('nickname')(<Input prefix={<Icon type="user" style={{fontSize: 13}}/>}
                                                      type="text"
                                                      placeholder="请输入客人昵称"/>)}
            </FormItem>
            <FormItem>
